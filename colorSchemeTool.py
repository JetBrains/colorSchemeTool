...
xml_tag_name = Attribute("XML_TAG_NAME", text, scope='entity.name.tag.localname.xml')
...
html_tag_name = Attribute("HTML_TAG_NAME", xml_tag_name, scope="entity.name.tag.block.xml")
