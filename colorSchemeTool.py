...
default_identifier=Attribute("DEFAULT_IDENTIFIER", text)
...
default_operation_sign=Attribute("DEFAULT_OPERATION_SIGN", text, scope='punctuation')
...
default_doc_comment_markup=Attribute("DEFAULT_DOC_COMMENT_MARKUP", text)
default_doc_comment_tag=Attribute("DEFAULT_DOC_COMMENT_TAG", text)
